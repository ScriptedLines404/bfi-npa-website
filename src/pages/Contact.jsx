/* src/pages/Contact.jsx - Navy + Amber Color Scheme (Matching About Page) */
...
const Contact = () => {
  ...
  return (
    <div className="animate-fade-in">
      ...
      <section className="py-16 bg-[#F3F4F6]" id="contact-form">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 bg-[#F3F4F6] border border-gray-200 rounded-lg focus:outline-none focus:border-[#F59E0B] transition-colors text-gray-700 placeholder:text-gray-400"
                      value={formData.name}
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows="4"
                      required
                      className="w-full px-4 py-3 bg-[#F3F4F6] border border-gray-200 rounded-lg focus:outline-none focus:border-[#F59E0B] transition-colors text-gray-700 placeholder:text-gray-400 resize-none"
      ...
      {/* Google Map Embed - BFI-NPA Resolution Services P Ltd Location */}
      <section className="py-0">
        <AnimatedSection direction="up" threshold={0.3}>
          <div className="w-full h-96">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3886.253507405895!2d80.2644342!3d13.0306121!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a5267d18ace29a3%3A0xfe8c34b6505ef7a6!2sBFI-NPA%20Resolution%20Services%20P%20Ltd!5e0!3m2!1sen!2sin!4v1744280000000!5m2!1sen!2sin"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
              loading="lazy"
              title="BFI-NPA Resolution Services P Ltd - Mylapore, Chennai"
        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {whyChooseItems.map((item, idx) => (
              <AnimatedCard key={idx} delay={idx * 100} direction="up" className="group bg-[#F3F4F6] rounded-xl p-6 shadow-md hover:shadow-xl transition-all hover:-translate-y-1 border border-gray-100 hover:border-[#F59E0B]">
