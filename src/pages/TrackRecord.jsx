/* src/pages/TrackRecord.jsx - Deep Navy + Amber Color Scheme (Matching About Page) */
          ...
          <div className="space-y-6 mt-8">
            {transactions.map((transaction, idx) => (
              <AnimatedCard 
                ...
                delay={idx * 100} 
                direction="up"
                className="bg-[#FFF3E4] rounded-xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100 hover:border-[#F59E0B]"
              >
        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <AnimatedCard delay={100} direction="up" className="text-center p-6 bg-[#FFF3E4] rounded-xl shadow-md hover:shadow-xl transition-all">
              ...
              <div className="text-2xl font-bold text-[#0A2540]">₹500+ Cr</div>
            ...
            <AnimatedCard delay={200} direction="up" className="text-center p-6 bg-[#FFF3E4] rounded-xl shadow-md hover:shadow-xl transition-all">
              ...
              <div className="text-2xl font-bold text-[#0A2540]">50+</div>
