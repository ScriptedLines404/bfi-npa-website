/* src/pages/Services.jsx - Deep Navy + Amber Color Scheme (Matching About Page) */
          ...
          <AnimatedSection direction="up" threshold={0.3}>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <AnimatedCard delay={100} direction="up" className="text-center p-6 bg-[#FFF3E4] rounded-xl shadow-md hover:shadow-xl transition-all">
                ...
                <h3 className="text-xl font-bold text-[#0A2540] mb-2">Fast Execution</h3>
              ...
              <AnimatedCard delay={200} direction="up" className="text-center p-6 bg-[#FFF3E4] rounded-xl shadow-md hover:shadow-xl transition-all">
                ...
                <h3 className="text-xl font-bold text-[#0A2540] mb-2">Maximized Recovery</h3>
              ...
              <AnimatedCard delay={300} direction="up" className="text-center p-6 bg-[#FFF3E4] rounded-xl shadow-md hover:shadow-xl transition-all">
                ...
                <h3 className="text-xl font-bold text-[#0A2540] mb-2">Legal Compliance</h3>
        ...
        <div className="container-custom">
          <div className="grid md:grid-cols-4 gap-6">
            ...
            <AnimatedCard delay={200} direction="up" className="text-center p-6 bg-white rounded-xl shadow-md hover:shadow-xl transition-all">
              <div className="text-3xl font-bold text-[#F59E0B] mb-2">25+</div>
            ...
            <AnimatedCard delay={400} direction="up" className="text-center p-6 bg-white rounded-xl shadow-md hover:shadow-xl transition-all">
