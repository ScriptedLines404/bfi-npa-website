/* src/pages/ResolutionMechanisms.jsx - Navy + Amber Color Scheme (Matching Legal Mechanisms) */
...
const ResolutionMechanisms = () => {
  ...
  return (
    <div className="animate-fade-in">
      {/* Hero Section - Full Screen Navy Blue like Legal Mechanisms */}
                      ...
                      >
                        <div className="p-6 md:p-8">
                          ...
                          {resolution.valueDelivered && (
                            <div className="mb-6 bg-[#F59E0B]/10 rounded-lg p-4">
